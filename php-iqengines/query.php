...
# Image to query with
 ...
 //In my example, the file is received from an iPhone application.
  if( move_uploaded_file($_FILES["temp"]["tmp_name"], $target) ) {
      //CONTINUE
...
$context = stream_context_create(array('http' => array('method' => 'POST', 'header' => 'Content-type: multipart/form-data; boundary=' . $boundary . "\r\n" . 'Authorization: Token ' . $query_key, 'content' => $body)));
